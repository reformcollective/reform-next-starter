...
1. Update all existing packages with `pnpm update` (or `pnpm update --latest` if you want to include breaking changes) (feel free to update the starter repository as well)
